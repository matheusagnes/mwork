...
class MTime extends MInput
{
    ...
    public function show()
    {
        ...
        return "<input name='{$this->name}' $disabled id = '{$this->id}' $add  size='{$this->size}' value='{$this->value}' {$maxlength} type='text' $required  $OnKeyPress /> <script> $('#{$this->id}').timepicker({});</script>";
